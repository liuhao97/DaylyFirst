package com.devliu.daylyfirst.nightmode;
...
//                            Log.e("TAG", attrs.getAttributeName(i) + " , " + attrs.getAttributeValue(i));
     ...
     * @param ctx  上下文
     */
    private static void refreshUI(Activity ctx, int style) {
        ...
        if(style==R.style.DayColorTrans || style==R.style.NightColorTrans){
            return;
        }else{
